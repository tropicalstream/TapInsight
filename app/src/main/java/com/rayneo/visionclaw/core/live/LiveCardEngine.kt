package com.rayneo.visionclaw.core.live
 ...
 *
 * Runs process-wide from VisionClawApp.onCreate. One worker thread,
...
object LiveCardEngine {
    ...
    private fun refreshPin(pin: HudPin) {
        ...
        try {
            val apiKey = AppPreferences(context).geminiApiKey.trim()
    ...
    private fun fetchPageText(url: String): String {
        ...
        conn.setRequestProperty("User-Agent", "Mozilla/5.0 (Linux; Android 14) TapInsight")
