...
- **Release:** TapInsight Alpha OC.2
- **Download APK:** [GitHub Releases](https://github.com/tropicalstream/TapInsight/releases)
- **User Manual:** [TapInsight-User-Guide.html](TapInsight-User-Guide.html)
- **Overview Video:** [TapInsight Overview](https://youtu.be/42DV0rl1NOo)
...
Download the latest packaged APK from the project's **[GitHub Releases](https://github.com/tropicalstream/TapInsight/releases)** page. The release also includes the clean source tarball and release notes for that build.
...
1. **Download the latest APK** from **[GitHub Releases](https://github.com/tropicalstream/TapInsight/releases)**
2. Sideload it onto your RayNeo X3 Pro via ADB: `adb install <downloaded-apk>`
...
#    credentials-file: $HOME/.cloudflared/YOUR_TUNNEL_ID.json
#    ingress:
